...
# Creating the second plot with two sets of data on the same plot
  ...
  plt.tight_layout()
  figure_name = "new setonix hypoxia control tumor volume vs time " + str(i) + " .png"
...
for i in range(1,9):
  ...
  plt.tight_layout()
  figure_name = "new setonix hypoxia anti PD L1 10 tumor volume vs time " + str(i) + " .png"
  plt.savefig(figure_name)
  plt.close()
...
for i in range(1,7):
  ...
  plt.tight_layout()
  figure_name = "new setonix hypoxia anti PD L1 15 tumor volume vs time " + str(i) + " .png"
  plt.savefig(figure_name)
...
# Creating the second plot with two sets of data on the same plot
  ...
  plt.legend()
  plt.tight_layout()
  figure_name = "new setonix hypoxia anti-CTLA-4 10 tumor volume vs time " + str(i) + " .png"
  plt.savefig(figure_name)
  plt.close()
...
# Creating the second plot with two sets of data on the same plot
  ...
  plt.legend()
  plt.tight_layout()
  figure_name = "new setonix hypoxia anti-CTLA-4 15 tumor volume vs time " + str(i) + " .png"
  plt.savefig(figure_name)
  plt.close()
...
dataFrame.to_csv("new setonix hypoxia best parameters control.csv", index=False)
std_devs.to_csv("new setonix hypoxia errors control.csv", index=False)
means.to_csv("new setonix hypoxia means control.csv", index=False)
