...
bed = 80
file_name = 'smaller sampling range hypoxia RT ' + str(RT_fractions) + ' PD ' + str(PD_fractions) + ' CTLA4 ' + str(CTLA4_fractions) + ' f.csv'
...
#     print('k', k)
#     print(params[k])
args = [(k, params) for k in range(3000, min(iterations,3600))]
