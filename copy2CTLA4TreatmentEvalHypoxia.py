...
bed = 80
file_name = 'smaller sampling range hypoxia RT ' + str(RT_fractions) + ' PD ' + str(PD_fractions) + ' CTLA4 ' + str(CTLA4_fractions) + ' o.csv'
...
#     print('k', k)
#     print(params[k])
args = [(k, params) for k in range(8400, min(iterations,9000))]
